    ...
    <div className="absolute inset-0 preserve-3d flex items-center justify-center" style={{ transform: `translateZ(${zOffset}px)` }}>
      ...
      <div className="text-center preserve-3d max-w-2xl mx-auto px-6" style={{ transform: 'translateZ(80px)' }}>
        ...
        <h1 className="font-serif text-5xl md:text-7xl text-ivory/80 leading-tight mb-6">
          The Journey<br/>
          <span className="italic text-champagne">Begins</span>
        </h1>
  ...
  return (
    <div className="absolute inset-0 preserve-3d" style={{ transform: `translateZ(${zOffset}px)` }}>
      ...
      <div className="absolute left-[8%] top-[18%] w-[45%] preserve-3d bg-ivory/70 backdrop-blur-lg p-6" style={{ transform: 'translateZ(120px)' }}>
        <p className="font-sans text-[10px] tracking-[0.35em] uppercase text-gold-500/60 mb-3">Founded 2012</p>
        <h2 className="font-serif text-4xl md:text-6xl leading-tight mb-8 text-obsidian/80">
          Born from<br/>
          <span className="italic text-gold-500">Wanderlust</span>
        </h2>
        <p className="font-sans text-sm md:text-base text-obsidian/60 leading-relaxed max-w-md border-l border-obsidian/10 pl-5">
          In a small café in Reykjavik, Wanderfar was born from a single
          belief — that travel should not merely be seen, but felt. Our founder, Elias
          Vinter, spent a decade tracing the Arctic Circle by foot, a journey that
          would come to define the soul of our company.
        </p>
        <div className="flex gap-10 mt-10">
          <div>
            <p className="font-serif text-3xl text-gold-500">2012</p>
          ...
          <div>
            <p className="font-serif text-3xl text-gold-500">2014</p>
            <p className="font-sans text-[9px] tracking-[0.25em] uppercase text-obsidian/50 mt-2">First Expedition</p>
          </div>
          <div className="w-[1px] bg-obsidian/10"></div>
          <div>
            <p className="font-serif text-3xl text-gold-500">2017</p>
    ...
    <div className="absolute inset-0 preserve-3d flex items-center justify-center" style={{ transform: `translateZ(${zOffset}px)` }}>
      ...
      <div className="text-center preserve-3d max-w-3xl mx-auto bg-ivory/70 backdrop-blur-lg px-8 py-10" style={{ transform: 'translateZ(80px)' }}>
        ...
        <blockquote className="font-serif text-3xl md:text-5xl leading-relaxed text-obsidian/80 mb-10">
          ...
          Our journeys are simply an echo of<span className="italic text-gold-500"> that rhythm.</span>"
        </blockquote>
        <p className="font-sans text-sm text-obsidian/50 tracking-[0.3em] uppercase max-w-lg mx-auto">
          Every trail begins with the land — its history, its character, its hidden paths.
        </p>
      </div>
      <div className="absolute bottom-[18%] left-1/2 -translate-x-1/2 flex gap-8 px-8 py-4" style={{ transform: 'translateZ(150px)' }}>
        {['Respect the Land', 'Travel Deeply', 'Leave Lightly'].map((principle, i) => (
          <div key={principle} className="text-center px-4">
            <p className="text-gold-500/40 font-serif text-2xl">0{i + 1}</p>
...
function DestinationsSection({ zOffset }: { zOffset: number }) {
  return (
    <div className="absolute inset-0 preserve-3d" style={{ transform: `translateZ(${zOffset}px)` }}>
      <div className="absolute top-[10%] left-[10%] bg-ivory/70 backdrop-blur-lg px-4 py-2" style={{ transform: 'translateZ(80px)' }}>
        <p className="font-sans text-[10px] tracking-[0.35em] uppercase text-gold-500/60 mb-3">Realms</p>
        <h2 className="font-serif text-4xl md:text-5xl leading-tight text-obsidian/80">
          The First<span className="italic text-gold-500"> Step</span>
        </h2>
      </div>
      <div className="absolute top-[38%] left-1/2 -translate-x-1/2 flex items-start gap-6" style={{ transform: 'translateZ(60px)' }}>
        {experienceImages.slice(0, 3).map((img, i) => (
          <div key={i} className="preserve-3d group" style={{ width: 260 }}>
            <div className="w-full h-[180px] overflow-hidden border border-champagne/10">
            ...
            <div className="mt-3 bg-ivory/70 backdrop-blur-lg p-4">
              <p className="font-sans text-[9px] tracking-[0.3em] uppercase text-gold-500/60 mb-1">0{i + 1}</p>
      ...
      <div className="absolute bottom-[15%] right-[10%] max-w-xs bg-ivory/70 backdrop-blur-lg px-4 py-2" style={{ transform: 'translateZ(180px)' }}>
...
function ExpeditionsBridge({ zOffset }: { zOffset: number }) {
  return (
    <div className="absolute inset-0 preserve-3d flex items-center justify-center" style={{ transform: `translateZ(${zOffset}px)` }}>
      ...
      <div className="absolute w-[500px] h-[500px] rounded-full border border-champagne/10" style={{ transform: 'translateZ(-200px)' }}></div>
      <div className="text-center preserve-3d max-w-xl mx-auto bg-ivory/70 backdrop-blur-lg px-8 py-10" style={{ transform: 'translateZ(100px)' }}>
        <p className="font-sans text-[10px] tracking-[0.35em] uppercase text-gold-500/60 mb-6">Prologue</p>
        <h2 className="font-serif text-5xl md:text-7xl leading-tight text-obsidian/80 mb-8">
          What Follows<br/>
          <span className="italic text-gold-500">is Extraordinary.</span>
        </h2>
    ...
    <div className="w-full text-ivory relative z-[3]">
      ...
      <MobileSection overlay={false}>
        <div className="bg-ivory/70 backdrop-blur-lg p-6 text-left">
          ...
          <p className="font-sans text-sm text-obsidian/60 leading-relaxed border-l border-obsidian/10 pl-4 mb-6">
            In a small café in Reykjavik, Wanderfar was born from a single
            belief — that travel should not merely be seen, but felt.
          </p>
          <div className="flex gap-4 justify-between">
            <div className="text-center">
              <p className="font-serif text-2xl text-gold-500">2012</p>
              <p className="font-sans text-[8px] tracking-[0.25em] uppercase text-obsidian/50 mt-1">Founded</p>
            </div>
            <div className="text-center">
              <p className="font-serif text-2xl text-gold-500">2014</p>
              <p className="font-sans text-[8px] tracking-[0.25em] uppercase text-obsidian/50 mt-1">First Expedition</p>
            </div>
            <div className="text-center">
              <p className="font-serif text-2xl text-gold-500">2017</p>
      ...
      <MobileSection>
        ...
        <blockquote className="font-serif text-2xl leading-relaxed text-ivory/80 mb-8">
          "The earth carries the memory of every footfall.<br/>
          Our journeys are simply an echo of<span className="italic text-champagne"> that rhythm.</span>"
        </blockquote>
      ...
      <MobileSection overlay={false}>
        <div className="text-left">
          <div className="bg-ivory/70 backdrop-blur-lg px-4 py-3 mb-6 inline-block">
            <p className="font-sans text-[10px] tracking-[0.35em] uppercase text-gold-500/60">Realms</p>
          ...
          <div className="space-y-4">
            {experienceImages.slice(0, 3).map((img, i) => (
              <div key={i} className="flex gap-3">
                <div className="w-24 h-24 shrink-0 overflow-hidden border border-champagne/10">
                  <img src={img} className="w-full h-full object-cover" alt="" />
                </div>
                <div className="bg-ivory/70 backdrop-blur-lg p-3 flex-1">
                  <p className="font-sans text-[8px] tracking-[0.3em] uppercase text-gold-500/60">0{i + 1}</p>
      ...
      <MobileSection>
        ...
        <h2 className="font-serif text-4xl leading-tight text-ivory/80 mb-6">
          What Follows<br/>
          <span className="italic text-champagne">is Extraordinary.</span>
        </h2>
